...
export const config = {
  ...
  superAdminEmail: (process.env.SUPER_ADMIN_EMAIL ?? "jeetesh.bahuguna@gmail.com").toLowerCase(),
  superAdminInitialPassword: process.env.SUPER_ADMIN_INITIAL_PASSWORD ?? "ChangeMe"
};
